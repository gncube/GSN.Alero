<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home.ascx.cs" Inherits="GSN.Modules.GSN.Alero.Home" %>
...
<div id="CarouselPane" runat="server" class="carousel slide" containertype="G" containername="GSN.Alero" containersrc="Blank.ascx" />
